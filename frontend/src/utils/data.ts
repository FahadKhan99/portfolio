...
export const SOCIAL_LINKS = [
  ...
  },
  {
    ...
    bgColor: "hover:bg-blue-100 dark:hover:bg-blue-600/20",
  },
  {
    icon: FiTwitter,
    name: "Twitter",
    ...
    bgColor: "hover:bg-sky-100 dark:hover:bg-sky-600/20",
  },
  {
    icon: Mail,
    name: "Email",
    ...
    bgColor: "hover:bg-green-100 dark:hover:bg-green-600/10",
  },
];
